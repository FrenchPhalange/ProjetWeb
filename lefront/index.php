...
<body>
    ...
    <main>
      ...
      <section  id="pictures'gym" class="section section-7">
        <p class="title-shape-health">Vous voulez un coach pour vous aider ?</p>
        <div>
            <div>
                <p>Une scéance avec un coach peut vous aider à:</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore doloremque ut id temporibus omnis nostrum, minus ipsam facilis odio doloribus ipsum molestias aut, sed tempora blanditiis eveniet repudiandae, voluptatum explicabo.</p>
            </div>
            <div>
                <img src="/img/gym-7.jpg" alt="" />
                <p>Reserve now</p>
